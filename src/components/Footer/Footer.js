...
const Footer = () => {
  return (
    ...
    <div className="flex justify-center">  <hr className=" border-gray-200 w-3/4  sm:mx-autolg:my-8" /></div>  

        <div className="mx-auto w-full max-w-screen-xl  p-4 py-12 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="#" className="flex items-center">
                <img src="" className="h-8 mr-3" alt="Hackthon Logo" />
          ...
          <div className="pt-8 sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
              ...
              <a href="#" className="text-gray-500 h hover:text-white">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
